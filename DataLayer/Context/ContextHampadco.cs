...
namespace DataLayer.Context
{
    public class ContextHampadco:DbContext
    {
        ...
        public DbSet<Tbl_ColorProduct> Tbl_ColorProducts { get; set; }
        public DbSet<Tb_city> tb_Cities { get; set; }
        public DbSet<Tb_namayeshgah> tb_Namayeshgahs { get; set; }
        public DbSet<Tb_TNamayeshgah> tb_TNamayeshgahs { get; set; }
        public DbSet<Tbl_Pages> tbl_Pages { get; set; }
        public DbSet<Tbl_Calender> tbl_Calenders { get; set; }
       public DbSet<Tbl_galleryblog> tbl_Galleryblogs { get; set; }
    ...
    public class ToDoContextFactory : IDesignTimeDbContextFactory<ContextHampadco>
    {
        public ContextHampadco CreateDbContext(string[] args)
        {
            var builder = new DbContextOptionsBuilder<ContextHampadco>();
               builder.UseSqlServer("Data Source=.;initial Catalog=shoproyal;integrated Security=SSPI;MultipleActiveResultSets=true");
