...
namespace pransa.Areas.Admin.Controllers
{
    ...
    public class  CommentController: BaseController
    {
        ...
        {
            var nazar=db.Tbl_Comments.Where(a=>a.Id.ToString()==Q.Id).FirstOrDefault();
    ...
    //         {
    //             var name=db.Tbl_User.Where(a=>a.Id==Convert.ToInt32(item.User) ).FirstOrDefault();
    ...
    //     {
    //         var qcomment=db.Tbl_Comments.Where(a=>a.Id==id).FirstOrDefault();
