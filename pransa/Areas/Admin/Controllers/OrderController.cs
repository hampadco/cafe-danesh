...
namespace pransa.Areas.Admin.Controllers {
    ...
    public class OrderController : BaseController {
        ...
        //             var user=db.Tbl_User.Where(a=>a.Id.ToString()==item.Id_user).FirstOrDefault();
        ...
        //     var qorder = db.Tbl_Order.Where (a => a.Id==id).FirstOrDefault ();
        ...
        public IActionResult send(int id)
        {
            var order=db.Tbl_Order.Where(a=>a.RFactor==id).FirstOrDefault();
            order.State="OKK";
