...
namespace pransa.Areas.Admin.Controllers {
    ...
    public class ProductController : BaseController {
        ...
        public IActionResult addproduct () {
            ...
            //////////////////////////////////////////////////////////////////////////////////list
            /// man
            //  var q = db.tbl_category.Where (a => a.NameCat == "فروشگاه").FirstOrDefault ();
            /// 
        ...
        public IActionResult Arshive()
        {
            ...
            if (list.Count != 0 )
            {
                ...
                foreach (var item in list) {
                    var qcat = db.tbl_category.Where (a => a.Id == Convert.ToInt32(item.CategoryChildIdPro)).FirstOrDefault ();
        ...
        public async Task<IActionResult> add (Vm_Product pro) {
            ...
            var fcat=db.tbl_category.Where(s=>s.Id.ToString()==pro.CategoryChildIdPro).FirstOrDefault().FatherIdCat;
            var cat=db.tbl_category.Where(d=>d.Id== fcat).FirstOrDefault().Id;
            ...
            db.SaveChanges ();
            var q = db.Tbl_Product.OrderByDescending (a => a.Id).Take (1).FirstOrDefault ();
            ////////////////////////////////////////////////////////upload multi image
            ...
            if ( pro.Color != null )
            {
                ...
                var qpro = db.Tbl_Product.OrderByDescending( a => a.Id ).Take(1).FirstOrDefault();
        ...
        public IActionResult del (int id) {
            var q = db.Tbl_Product.Where (a => a.Id == id).FirstOrDefault ();
        ...
        public IActionResult hiden (int id) {
            var qa = db.Tbl_Product.Where (a => a.Id == id).FirstOrDefault ();
            qa.TypeCarPro = "0";
        ...
        public IActionResult update (int id) {
            ...
            //////////////////////////////////////////////////////////////////////////////////list
            var qproduct = db.Tbl_Product.Where (a => a.Id == id).FirstOrDefault ();
       ...
       {
           var qlist=db.Tbl_Product.Where(a=>a.Id==pro.Id).FirstOrDefault();
           if (pro.upload_imgs != null)
           {
